...
class Solitaire_normal(Etat):
	def action(self):
		if self.animal.a_faim == True and self.animal.a_soif == False:
			self.animal.changer_etat(Solitaire_faim)
		elif self.animal.a_faim == False and self.animal.a_soif == True: ## Pb : un animal ne peut pas avoir faim et soir en même temps, il faut créer une class faim_soif
